...
# BenchVault v3.4.1 - Installation Guide
...
1. Download `BenchVault_Setup_3.4.1.exe` (~50 MB)
...
### Step 1: Run Installer
1. Download `BenchVault_Setup_Client_3.4.1.exe` (~25-30 MB)
...
### Server
```cmd
BenchVault_Setup_3.4.1.exe /SILENT /DIR="C:\BenchVault"
```

### Client
```cmd
BenchVault_Setup_Client_3.4.1.exe /SILENT /DIR="C:\BenchVault Client"
```

...
# BenchVault v3.3.0 - Installation Guide
...
1. Download `BenchVault_Setup_3.3.0.exe` (~50 MB)
...
### Step 1: Run Installer
1. Download `BenchVault_Setup_Client_3.3.0.exe` (~25-30 MB)
...
### Server
```cmd
BenchVault_Setup_3.3.0.exe /SILENT /DIR="C:\BenchVault"
```

### Client
```cmd
BenchVault_Setup_Client_3.3.0.exe /SILENT /DIR="C:\BenchVault Client"
```
